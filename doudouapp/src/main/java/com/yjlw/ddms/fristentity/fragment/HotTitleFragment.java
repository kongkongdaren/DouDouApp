...
public class HotTitleFragment extends Fragment {
    ...
    private void DownHotAllData() {
        ...
        params.addBodyParameter("sign", "99f1bcd28fa73dd09879155786b621ba");
        params.addBodyParameter("uid", "10283273");
        params.addBodyParameter("uuid", "bdf542fa8eb3bcbc457a5383dc48fc0c");
